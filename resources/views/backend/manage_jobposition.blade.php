            ...
            <div class="ms-auto">
                ...
                <div class="d-flex align-items-center position-relative mb-md-0 mb-3">
                    <div class="input-group input-group-sm input-group-solid border">
                        ...
                        <input type="text" class="form-control form-control-sm form-control-solid border-left-0" name="search-dtJobPosition" id="search-dtJobPosition" placeholder="Pencarian..." />

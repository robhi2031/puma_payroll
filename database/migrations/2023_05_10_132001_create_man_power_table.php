...
class CreateManPowerTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('man_power', function (Blueprint $table) {
            ...
            $table->decimal('daily_basic', 9, 2)->default(0);
            $table->decimal('basic_salary', 9, 2)->default(0);
            $table->decimal('ot_rate', 9, 2)->default(0);
            $table->decimal('attendance_fee', 9, 2)->default(0);
            $table->decimal('leave_day', 9, 2)->default(0);
            $table->decimal('premi_sore', 9, 2)->default(0);
            $table->decimal('premi_malam', 9, 2)->default(0);
            $table->decimal('thr', 9, 2)->default(0);
            $table->decimal('transport', 9, 2)->default(0);
            $table->decimal('uang_cuti', 9, 2)->default(0);
            $table->decimal('uang_makan', 9, 2)->default(0);
            $table->decimal('bonus', 9, 2)->default(0);
            $table->decimal('interim_location', 9, 2)->default(0);
            $table->decimal('tunjangan_jabatan', 9, 2)->default(0);
            $table->decimal('p_biaya_fasilitas', 9, 2)->default(0);
            $table->decimal('pengobatan', 9, 2)->default(0);

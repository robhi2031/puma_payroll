...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['js'] = array(
            ...
            '/dist/scripts/backend/manage_project.init.js'
        );
    ...
    public function show(Request $request)
    {
        if(isset($request->idp)){
            try {
                ...
                $getRow = Project::whereId($request->idp)->first();
                if($getRow != null){
            ...
            $output = Datatables::of($data)->addIndexColumn()
                ...
                ->editColumn('status', function ($row) {
                    $statusCustom = '<span data-kt-element="status" class="badge badge-light-danger" data-bs-toggle="tooltip" title="Tidak Aktif"><i class="bi bi-sign-stop me-1 text-danger"></i>Tidak Aktif</span>';
                    ...
                    if($row->status == 1) {
                        $statusCustom = '<span data-kt-element="status" class="badge badge-light-primary" data-bs-toggle="tooltip" title="Aktif"><i class="bi bi-check2-circle text-primary me-1"></i>Aktif</span>';
                    }
                    return $statusCustom;
                })
